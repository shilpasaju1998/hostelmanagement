 ...
 public class ViewCustomerActivity extends Activity {
   TableLayout grid;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
        String []cap ={
        		"uname","name", "address","desciption"
        };
        
        ServerConnection con = new ServerConnection();
        String dts[][] = null;
        String data = con.doPost("guest/customer.jsp", dts);
        ...
        for(String d : recs){
	      ...
	      bookImg.setImageResource(R.drawable.accept);
	      ...
	      tr.addView(bookImg);
	      ///
	      ImageView bookIm = new ImageView(this);
	      bookIm.setImageResource(R.drawable.reject);
	     
	      bookIm.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				go(bid);
			}
